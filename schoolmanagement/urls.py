...
urlpatterns = [
    ...
    path('admindologin', views.admindologin, name="admindologin"),
    ...
    path('admin-sessionYear', views.admin_sessionYear, name='admin-sessionYear'),
    path('admin-add-sessionYear', views.admin_add_sessionYear, name='admin-add-sessionYear'),
